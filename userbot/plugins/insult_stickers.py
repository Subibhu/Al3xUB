...
async def _(event):
    ...
    packname = f"Insult_vol_{pack}_with_756285876"
    packshortname = f"Insult_with_756285876"
    await event.edit("`Look dat way,it's a gurl!\nMeanwhile, lemme kang this insult sticker'ass like i kanged this code hehe ヽ༼ ಠ益ಠ ༽ﾉ`")
    ...
    if is_a_s:
        ...
        packname = f"Anim_Insult_vol_{pack}_with_756285876"
        if userid == 719877937:
            packshortname = "Anim_Insult_with_756285876"
        else:
            packshortname = f"Anim_Insult_with_756285876" # format: Uni_Borg_userid
    ...
    await event.edit(f"**Kanged!** `This Insult sticker has been stolen to` [this place](t.me/addstickers/{packshortname})"
